...
const CreateNewApplication = () => {
    ...
    return (
        <Dialog>
        <DialogTrigger className='p-3 px-12 bg-neutral-800 text-white font-semibold rounded-lg hover:bg-neutral-900 cursor-pointer transition-all duration-300'>Create New App</DialogTrigger>
        <DialogContent className='bg-primary/20 border-none text-white'>
            <DialogHeader>
